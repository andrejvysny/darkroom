...
//
// Worked example for the `tauri-v2-ui-testing` skill — see references/example-darkroom.md.
// For a fresh app, start from assets/tauriMock.template.ts instead of copying this.
